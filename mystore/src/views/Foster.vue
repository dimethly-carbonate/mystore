<template>
  <div style="width: 100%; height: 100%">
    ...
    >
      ...
      <el-form-item label="报修商品：">
        <el-input
            v-model="fosName"
            style="width: 300px"
            clearable
            placeholder="请输报修商品名称"
        >
        </el-input>
      </el-form-item>
      ...
      <div>
        ...
        ><i class="el-icon-circle-plus-outline"></i>新增维修信息</el-button
        >
        <el-popconfirm
            class="ml-5"
    ...
    >
      ...
      <el-table-column prop="sender" label="申请人" width="220">
      </el-table-column>
      <el-table-column prop="phone" label="联系方式" width="220">
      </el-table-column>
      <el-table-column prop="fosName" label="报修商品" width="220">
      </el-table-column>

      <el-table-column prop="fosVariety" label="种类" width="220">
      </el-table-column>
    ...
    >
      <template slot="title">
        <div style="font-size: 25px; font-weight: bold">新增维修信息</div>
      </template>
      <el-form
          :model="form"
          :inline="true"
          ...
          class="demo-form-inline"
      >
        <el-form-item label="申请人" style="margin-left: 50px" prop="sender">
          <el-input
              v-model="form.sender"
              autocomplete="off"
              style="width: 300px"
        ...
        <el-form-item label="种类" style="margin-left: 75px" prop="fosVariety">
          <el-input
        ...
        <el-form-item label="备注" style="margin-left: 45px">
          <el-input
              v-model="remarkss"
              style="width: 730px"
              type="textarea"
    ...
    <el-dialog :visible.sync="vis1" :show-close="dd" :close-on-click-modal="aa">
      ...
      >
        ...
        <el-form-item label="报修商品名称" style="margin-left: 10px">
          <el-input
              disabled
              v-model="form.fosName"
              autocomplete="off"
        ...
        <el-form-item label="种类" style="margin-left: 75px">
          <el-input
              disabled
              v-model="form.fosVariety"
              autocomplete="off"
        ...
        <el-form-item label="价格" class="redss" style="margin-left: 40px">
          <el-input
              disabled
              v-model="form.fosPrice"
              autocomplete="off"
    ...
    <el-dialog :visible.sync="vis" :show-close="dd" :close-on-click-modal="aa">
      <template slot="title">
        <div style="font-size: 25px; font-weight: bold">查看维修信息</div>
      </template>
      <el-form
          :model="form"
          :inline="true"
...
export default {
  ...
  methods: {
    ...
    payments() {
      ...
      console.log(this.dayCount + "维修天数");
